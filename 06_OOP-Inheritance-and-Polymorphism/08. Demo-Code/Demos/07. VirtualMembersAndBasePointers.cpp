...
void f(Vehicle* v) {
	std::cout << v->toString() << std::endl; // calls toString() depending on the ACTUAL type of the object
	v->stop(); // calls virtual stop() depending on the ACTUAL type of the object
