...
namespace SoftUni {
	...
	namespace CppFundamentals {
		std::vector<std::string> lectures{ "Basic Syntax", "Functions, Arrays, Vectors", "Strings and Streams", "STL Linear Containers", "STL Associative Containers", "Classes and Objects" };
	}

	namespace CppAdvanced {
		std::vector<std::string> lectures{ "Pointers and References", "Memory Management", "Advanced C++ Class Members", "Code Organization", "Destructors, Copy Assignment, Construction", "Inheritance and Polymorphism", "Pure-Virtual Members and Multiple Inheritance" };
	}
}
