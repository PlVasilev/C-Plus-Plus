...
int main_using_objects() {
    ...
    Person* newPerson = new Person(); // allocate memory for 1 Person, and initialize by default
    ...
    delete newPerson; // release memory, which we used for Person instance
